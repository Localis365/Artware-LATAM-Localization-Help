...
La información de los porcentajes de actualización para el cálculo de la corrección monetaria de activos se encuentra al ingresar al buscador Configuración de Activos Fijos e ingresar en la ruta <b>Acciones → Corrección monetaria → Factor de corrección monetaria:</b>

![image](https://github.com/Localis365/Artware-LATAM-Localization-Help/blob/main/docs/Correcci%C3%B3n%20Monetaria%20Activo%20Fijo/img/FactoresCorreccionMonetaria/ConfAF-Page.png)
